...
import 'package:sky_checker/SKY_SCRAPPER/model/weather_model.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    fetchData(widget.cityname ?? "Ahmedabad");
    initConnectivity();
  ...
  fetchData(String text) async {
    ...
    // print("wm");
    //print(wm.current?.tempC.toString());
  }
                                    ...
                                    text: TextSpan(children: [
                                      ...
                                      TextSpan(
                                          text: DateFormat('dd-MM-yyyy HH:MM a')
                                              .format(
                                              wm?.timelines!.minutely![0].time!??DateTime.now()),
                                          style: TextStyle(
                                              fontWeight: FontWeight.w400,
                                              fontSize: 30)),
                                    ]),
                                        ...
                                        Container(
                                          ...
                                          child: Center(
                                              child: RichText(
                                                ...
                                                text: TextSpan(children: [
                                                  TextSpan(
                                                      text: DateFormat('HH:MM').format(wm
                                                          ?.timelines!
                                                          .daily![0]
                                                          .values!
                            ...
                            SliverToBoxAdapter(
                              child: Container(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text("AQI117"),
                                  trailing: Text("Full air quality forecast ▶"),
                                ),
                              ),
                            ),
                            // SliverFillRemaining(
